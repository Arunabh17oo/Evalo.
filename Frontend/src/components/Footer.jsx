...
const Footer = ({ user, activePage, navigateTo, setAuthOpen }) => {
    const scrollToTop = () => {
            ...
            <div className="footer-container">
                ...
                <div className="footer-brand-segment">
                    ...
                    <div className="social-wrap-v2">
                        <a href="https://github.com/evalo-ai" className="social-btn" aria-label="GitHub">
                ...
                <div className="footer-links-grid">
                    <div className="footer-nav-col">
                        ...
                        <ul className="nav-list-v2">
                            <li onClick={() => handleLinkClick("home", "features-section")}>Subjective AI</li>
                            <li onClick={() => handleLinkClick("home", "features-section")}>Hybrid Scoring</li>
                            <li onClick={() => handleLinkClick("home", "features-section")}>NLP Engine</li>
                            <li onClick={() => handleLinkClick("admin", "teacher-panel", true)}>Teacher Bridge</li>
                        </ul>
                    </div>
                    <div className="footer-nav-col">
                        ...
                        <ul className="nav-list-v2">
                            ...
                            <li onClick={() => handleLinkClick("home", "features-section")}>Tab Protection</li>
                            <li onClick={() => handleLinkClick("home", "features-section")}>Access Control</li>
                            <li onClick={() => handleLinkClick("admin", "admin-section", true)}>Audit Metadata</li>
                        </ul>
                    </div>
                    <div className="footer-nav-col">
                        <h4 className="nav-col-title" onClick={() => handleLinkClick("admin", "teacher-panel", true)}>Insights</h4>
                        <ul className="nav-list-v2">
                            <li onClick={() => handleLinkClick("admin", "teacher-panel", true)}>Performance Gap</li>
                            <li onClick={() => handleLinkClick("home", "student-join", true)}>Student Reports</li>
                            <li onClick={() => handleLinkClick("home", "student-join", true)}>Trend Analysis</li>
                    ...
                    <div className="footer-nav-col">
                        ...
                        <ul className="nav-list-v2">
                            ...
                            <li>Data Privacy</li>
                            <li>API Docs</li>
                            <li onClick={() => handleLinkClick("home", "status-section")}>System Status</li>
                        </ul>
                    </div>
                </div>
